...
import thumbnail from "../../assets/cycleImg.webp"
...
function Estimates() {
  ...
  const handleAddToCart = (estimate) => {
    // Create a cart item from the estimate
    const cartItem = {
      id: `estimate-${Date.now()}`, 
      title: `${estimate.formData.brand} Cycle`,
      price: estimate.finalPrice,
      thumbnail: estimate.formData.thumbnail || thumbnail, 
      brand: estimate.formData.frame,
      stock: 10, 
      quantity: 1,
              ...
              {estimateData.map((estimate, index) => (
                <div key={index} className="p-4 rounded-lg shadow-lg bg-white">
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      onClick={() => handleAddToCart(estimate)}
